...
#pred_file = './exp/04-05_14-45_JHU_VGG16_FPN/04-05_14-45_JHU_VGG16_FPN.txt'
exp_name = './saved_exp_results/count_vis_results'
    ...
    for i_sample in id_std:     
        ...
        if pred_data[i_sample]['num'] !=0:
            ...
            for i in range(pred_p.shape[0]):
                ...
                #num_pred_circles += 1
            #cv2.putText(img, "Pred Circles: {}".format(num_pred_circles), (30, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2) # 이미지에 동그라미 수 텍스트 추가
